...
* @returns {Number|Number[]|Array|Int8Array|Uint8Array|Uint8ClampedArray|Int16Array|Uint16Array|Int32Array|Uint32Array|Float32Array|Float64Array|Matrix|Null} absolute value(s) or null
*/
function abs( x, options ) {
	...
	if ( isArrayLike( x ) ) {
		...
		if ( opts.copy === false ) {
			...
			ctor = ctors( dt );
			if ( ctor === null ) {
				throw new TypeError( 'abs()::invalid input argument. Unrecognized/unsupported array-like object. Provide either a plain or typed array. Value: `' + x + '`.' );
			}
